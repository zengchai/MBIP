...
public class ElectricalDTO {
    ...
    public ElectricalDTO(String userName, double electricityusage, int days, String month, double proportion_factor, double amount,
     ...
     public ElectricalDTO(double electricityusage, int days, String month, double proportion_factor, double amount,
            double current_charge, String imageName, byte[] imageData) {
        this.electricityusage = electricityusage;
        this.days = days;
        this.month = month;
